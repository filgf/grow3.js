...
d,0.1,2E4);THREEx.FullScreen.bindKey({charCode:102});THREEx.WindowResize(this.renderer,this.camera);this.controls=new THREE.TrackballControls(this.camera,this.container);this.doScreenshot=f;a()};f.prototype.run=function(a){this.isRendering=!1;this.frameCount=0;this.scene=new THREE.Scene;this.scene.add(this.camera);this.camera.position.set(-25,-10,0);this.camera.lookAt(0);this.g=new grow3.System(this.scene,a,this.camera);this.g.build();this.g.hasLighting||(a=new THREE.PointLight(16772846,1.3),a.position.set(10,
