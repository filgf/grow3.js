...
c(function(){void 0!==this.cameraObj&&(this.scene.updateMatrixWorld(!0),this.parent.objectProto.matrixWorld.decompose(this.cameraObj.position,h,k),this.cameraObj.lookAt(0))});a.prototype.light=c(function(b,a,c){b=new THREE.PointLight(b,a,c);this.parent.objectProto.clone(b);this.parent.objectProto.parent.add(b);this.hasLighting=!0});a.prototype.buildModifier=function(b){return function(a){b.call(this,this.handleParameter(a));return this}};var c=a.prototype.buildModifier,d=new THREE.Matrix4;a.prototype.move=
c(function(b){d.makeTranslation(b,0,0);this.state.objectProto.matrix.multiplyMatrices(d,this.state.objectProto.matrix)});a.prototype.m=a.prototype.move;a.prototype.transHoriz=c(function(b){d.makeTranslation(0,b,0);this.state.objectProto.matrix.multiplyMatrices(d,this.state.objectProto.matrix)});a.prototype.tH=a.prototype.transHoriz;a.prototype.transVert=c(function(b){d.makeTranslation(0,0,b);this.state.objectProto.matrix.multiplyMatrices(d,this.state.objectProto.matrix)});a.prototype.tV=a.prototype.transVert;
a.prototype.scale=c(function(b){d.makeScale(b,b,b);this.state.objectProto.matrix.multiplyMatrices(d,this.state.objectProto.matrix)});a.prototype.s=a.prototype.scale;a.prototype.roll=c(function(b){b=b*Math.PI/180;d.makeRotationX(b);this.state.objectProto.matrix.multiplyMatrices(d,this.state.objectProto.matrix)});a.prototype.rX=a.prototype.roll;a.prototype.yaw=c(function(b){b=b*Math.PI/180;d.makeRotationY(b);this.state.objectProto.matrix.multiplyMatrices(d,this.state.objectProto.matrix)});a.prototype.rY=
a.prototype.yaw;a.prototype.pitch=c(function(b){b=b*Math.PI/180;d.makeRotationZ(b);this.state.objectProto.matrix.multiplyMatrices(d,this.state.objectProto.matrix)});a.prototype.rZ=a.prototype.pitch;a.prototype.material=c(function(b){this.state.mat=b});a.prototype.textParam=c(function(b){this.state.textParam!==b&&(this.state.textParamId=void 0);this.state.textParam=b});return a}();grow3=grow3||{};
grow3.Runner=function(){var e,f=function(c){e=this;this.isRendering=!1;var f=window.innerWidth,h=window.innerHeight,k=f/h;Detector.webgl?this.renderer=new THREE.WebGLRenderer({antialias:!0}):(c.appendChild(Detector.getWebGLErrorMessage()),this.renderer=new THREE.CanvasRenderer);this.renderer.setSize(f,h);this.container=document.createElement("div");c.appendChild(this.container);this.container.appendChild(this.renderer.domElement);this.camera=new THREE.PerspectiveCamera(45,k,0.1,2E4);THREEx.FullScreen.bindKey({charCode:102});
THREEx.WindowResize(this.renderer,this.camera);this.controls=new THREE.TrackballControls(this.camera,this.container);a()};f.prototype.run=function(a){this.isRendering=!1;this.scene=new THREE.Scene;this.scene.add(this.camera);this.camera.position.set(-25,-10,10);this.camera.lookAt(0);this.g=new grow3.System(this.scene,a,this.camera);this.g.build();this.g.hasLighting||(a=new THREE.PointLight(16772846,1.3),a.position.set(10,10,10),this.scene.add(a),a=new THREE.PointLight(15658751,1),a.position.set(-10,
-10,-10),this.scene.add(a));this.isRendering=!0};var a=function(){requestAnimationFrame(a);e.isRendering&&(e.renderer.setClearColor(e.g.backgroundColor),e.renderer.render(e.scene,e.camera),e.controls.update())};return f}();
